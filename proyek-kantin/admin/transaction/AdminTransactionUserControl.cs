...
{
    public partial class AdminTransactionUserControl : UserControl
    {
        MySqlCommand command;
        public AdminTransactionUserControl()
        {
            InitializeComponent();
            LoadData();
        }
        ...
        private void LoadData()
        {
            ...
            string query = "SELECT * FROM transaksi WHERE tanggal_transaksi = '" + localDate.ToShortDateString() + "'";
